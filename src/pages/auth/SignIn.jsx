      ...
      <div className="hidden lg:flex lg:w-1/2 bg-ink flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <p className="font-serif text-4xl text-white leading-snug mb-6">
            Where service
            <br />
            finds its <span className="italic" style={{ color: '#5DCAA5' }}>sphere.</span>
          </p>
        ...
        <p className="text-white/30 text-xs relative z-10">12,400+ volunteers · 340+ NGOs · 17 SDGs</p>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-muted mb-2">Sign in as</label>
            ...
            <p className="text-center text-xs text-muted mt-6">
              By signing in you agree to our <Link to="/" className="text-teal hover:underline">Terms of Service</Link> and <Link to="/" className="text-teal hover:underline">Privacy Policy</Link>.
            </p>
          </motion.div>
        </div>
      </div>
